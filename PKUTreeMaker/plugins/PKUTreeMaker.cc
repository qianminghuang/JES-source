...
//  outTree_->Branch("triggerWeight"   ,&triggerWeight  ,"triggerWeight/D"  );
  ...
  outTree_->Branch("CorrelationGroupbJES_unc"          ,&CorrelationGroupbJES_unc         ,"CorrelationGroupbJES_unc/D"         );
  outTree_->Branch("CorrelationGroupIntercalibration_unc"          ,&CorrelationGroupIntercalibration_unc         ,"CorrelationGroupIntercalibration_unc/D"         );
  outTree_->Branch("CorrelationGroupMPFInSitu_unc"          ,&CorrelationGroupMPFInSitu_unc         ,"CorrelationGroupMPFInSitu_unc/D"         );
  outTree_->Branch("TimeRunH_unc"          ,&TimeRunH_unc         ,"TimeRunH_unc/D"         );
  outTree_->Branch("TimeRunG_unc"          ,&TimeRunG_unc         ,"TimeRunG_unc/D"         );
  outTree_->Branch("TimeRunEF_unc"          ,&TimeRunEF_unc         ,"TimeRunEF_unc/D"         );
  outTree_->Branch("TimeRunBCD_unc"          ,&TimeRunBCD_unc         ,"TimeRunBCD_unc/D"         );
  outTree_->Branch("FlavorPureBottom_unc"          ,&FlavorPureBottom_unc         ,"FlavorPureBottom_unc/D"         );
  outTree_->Branch("FlavorPureCharm_unc"          ,&FlavorPureCharm_unc         ,"FlavorPureCharm_unc/D"         );
  outTree_->Branch("FlavorPureQuark_unc"          ,&FlavorPureQuark_unc         ,"FlavorPureQuark_unc/D"         );
  outTree_->Branch("FlavorPureGluon_unc"          ,&FlavorPureGluon_unc         ,"FlavorPureGluon_unc/D"         );
  outTree_->Branch("FlavorPhotonJet_unc"          ,&FlavorPhotonJet_unc         ,"FlavorPhotonJet_unc/D"         );
  outTree_->Branch("FlavorZJet_unc"          ,&FlavorZJet_unc         ,"FlavorZJet_unc/D"         );
  outTree_->Branch("TotalNoFlavorNoTime_unc"          ,&TotalNoFlavorNoTime_unc         ,"TotalNoFlavorNoTime_unc/D"         );
  outTree_->Branch("TotalNoTime_unc"          ,&TotalNoTime_unc         ,"TotalNoTime_unc/D"         );
  outTree_->Branch("TotalNoFlavor_unc"          ,&TotalNoFlavor_unc         ,"TotalNoFlavor_unc/D"         );
  outTree_->Branch("Total_unc"          ,&Total_unc         ,"Total_unc/D"         );
  outTree_->Branch("SubTotalMC_unc"          ,&SubTotalMC_unc         ,"SubTotalMC_unc/D"         );
  outTree_->Branch("SubTotalAbsolute_unc"          ,&SubTotalAbsolute_unc         ,"SubTotalAbsolute_unc/D"         );
  outTree_->Branch("SubTotalScale_unc"          ,&SubTotalScale_unc         ,"SubTotalScale_unc/D"         );
  outTree_->Branch("SubTotalPt_unc"          ,&SubTotalPt_unc         ,"SubTotalPt_unc/D"         );
  outTree_->Branch("SubTotalRelative_unc"          ,&SubTotalRelative_unc         ,"SubTotalRelative_unc/D"         );
  outTree_->Branch("SubTotalPileUp_unc"          ,&SubTotalPileUp_unc         ,"SubTotalPileUp_unc/D"         );
  outTree_->Branch("PileUpEnvelope_unc"          ,&PileUpEnvelope_unc         ,"PileUpEnvelope_unc/D"         );
  outTree_->Branch("PileUpMuZero_unc"          ,&PileUpMuZero_unc         ,"PileUpMuZero_unc/D"         );
  outTree_->Branch("PileUpPtHF_unc"          ,&PileUpPtHF_unc         ,"PileUpPtHF_unc/D"         );
  outTree_->Branch("PileUpPtEC2_unc"          ,&PileUpPtEC2_unc         ,"PileUpPtEC2_unc/D"         );
  outTree_->Branch("PileUpPtEC1_unc"          ,&PileUpPtEC1_unc         ,"PileUpPtEC1_unc/D"         );
  outTree_->Branch("PileUpPtBB_unc"          ,&PileUpPtBB_unc         ,"PileUpPtBB_unc/D"         );
  outTree_->Branch("PileUpPtRef_unc"          ,&PileUpPtRef_unc         ,"PileUpPtRef_unc/D"         );
  outTree_->Branch("PileUpDataMC_unc"          ,&PileUpDataMC_unc         ,"PileUpDataMC_unc/D"         );
  outTree_->Branch("RelativeStatHF_unc"          ,&RelativeStatHF_unc         ,"RelativeStatHF_unc/D"         );
  outTree_->Branch("RelativeStatEC_unc"          ,&RelativeStatEC_unc         ,"RelativeStatEC_unc/D"         );
  outTree_->Branch("RelativeStatFSR_unc"          ,&RelativeStatFSR_unc         ,"RelativeStatFSR_unc/D"         );
  outTree_->Branch("RelativeFSR_unc"          ,&RelativeFSR_unc         ,"RelativeFSR_unc/D"         );
  outTree_->Branch("RelativeBal_unc"          ,&RelativeBal_unc         ,"RelativeBal_unc/D"         );
  outTree_->Branch("RelativePtHF_unc"          ,&RelativePtHF_unc         ,"RelativePtHF_unc/D"         );
  outTree_->Branch("RelativePtEC2_unc"          ,&RelativePtEC2_unc         ,"RelativePtEC2_unc/D"         );
  outTree_->Branch("RelativePtEC1_unc"          ,&RelativePtEC1_unc         ,"RelativePtEC1_unc/D"         );
  outTree_->Branch("RelativePtBB_unc"          ,&RelativePtBB_unc         ,"RelativePtBB_unc/D"         );
  outTree_->Branch("RelativeJERHF_unc"          ,&RelativeJERHF_unc         ,"RelativeJERHF_unc/D"         );
  outTree_->Branch("RelativeJEREC2_unc"          ,&RelativeJEREC2_unc         ,"RelativeJEREC2_unc/D"         );
  outTree_->Branch("RelativeJEREC1_unc"          ,&RelativeJEREC1_unc         ,"RelativeJEREC1_unc/D"         );
  outTree_->Branch("TimePtEta_unc"          ,&TimePtEta_unc         ,"TimePtEta_unc/D"         );
  outTree_->Branch("FlavorQCD_unc"          ,&FlavorQCD_unc         ,"FlavorQCD_unc/D"         );
  outTree_->Branch("SinglePionHCAL_unc"          ,&SinglePionHCAL_unc         ,"SinglePionHCAL_unc/D"         );
  outTree_->Branch("SinglePionECAL_unc"          ,&SinglePionECAL_unc         ,"SinglePionECAL_unc/D"         );
  outTree_->Branch("Fragmentation_unc"          ,&Fragmentation_unc         ,"Fragmentation_unc/D"         );
  outTree_->Branch("AbsoluteMPFBias_unc"          ,&AbsoluteMPFBias_unc         ,"AbsoluteMPFBias_unc/D"         );
...
const char* srcnames[nsrc] =
  {"AbsoluteStat", "AbsoluteScale",  "AbsoluteFlavMap", "AbsoluteMPFBias",
   ...
   "TimePtEta", "RelativeJEREC1", "RelativeJEREC2", "RelativeJERHF",
   ...
   "PileUpDataMC", "PileUpPtRef",
   "PileUpPtBB", "PileUpPtEC1", "PileUpPtEC2","PileUpPtHF", "PileUpMuZero",
   "PileUpEnvelope","SubTotalPileUp","SubTotalRelative","SubTotalPt", "SubTotalScale",
   "SubTotalAbsolute","SubTotalMC", "Total", "TotalNoFlavor", "TotalNoTime", "TotalNoFlavorNoTime",
   "FlavorZJet","FlavorPhotonJet","FlavorPureGluon","FlavorPureQuark","FlavorPureCharm","FlavorPureBottom",
   "TimeRunBCD", "TimeRunEF", "TimeRunG", "TimeRunH", "CorrelationGroupMPFInSitu", "CorrelationGroupIntercalibration",
...
for (int isrc = 0; isrc < nsrc; isrc++) {
   ...
   const char *name_jes = srcnames[isrc];
   JetCorrectorParameters *p_jes = new JetCorrectorParameters("CMSSW_8_0_32/src/L1Prefiring/EventWeightProducer/data/Summer16_23Sep2016V4_MC_UncertaintySources_AK4PFchs.txt", name_jes);
   JetCorrectionUncertainty *unc_jes = new JetCorrectionUncertainty(*p_jes);
   vsrc[isrc] = unc_jes;
} 
...
if(isrc==3)AbsoluteMPFBias_unc = sum2_up;
if(isrc==4)Fragmentation_unc = sum2_up;
if(isrc==5)SinglePionECAL_unc = sum2_up;
if(isrc==6)SinglePionHCAL_unc = sum2_up;
if(isrc==7)FlavorQCD_unc = sum2_up;
if(isrc==8)TimePtEta_unc = sum2_up;
if(isrc==9)RelativeJEREC1_unc = sum2_up;
if(isrc==10)RelativeJEREC2_unc = sum2_up;
if(isrc==11)RelativeJERHF_unc = sum2_up;
if(isrc==12)RelativePtBB_unc = sum2_up;
if(isrc==13)RelativePtEC1_unc = sum2_up;
if(isrc==14)RelativePtEC2_unc = sum2_up;
if(isrc==15)RelativePtHF_unc = sum2_up;
if(isrc==16)RelativeBal_unc = sum2_up;
if(isrc==17)RelativeFSR_unc = sum2_up;
if(isrc==18)RelativeStatFSR_unc = sum2_up;
if(isrc==19)RelativeStatEC_unc = sum2_up;
if(isrc==20)RelativeStatHF_unc = sum2_up;
if(isrc==21)PileUpDataMC_unc = sum2_up;
if(isrc==22)PileUpPtRef_unc = sum2_up;
if(isrc==23)PileUpPtBB_unc = sum2_up;
if(isrc==24)PileUpPtEC1_unc = sum2_up;
if(isrc==25)PileUpPtEC2_unc = sum2_up;
if(isrc==26)PileUpPtHF_unc = sum2_up;
if(isrc==27)PileUpMuZero_unc = sum2_up;
if(isrc==28)PileUpEnvelope_unc = sum2_up;
if(isrc==29)SubTotalPileUp_unc = sum2_up;
if(isrc==30)SubTotalRelative_unc = sum2_up;
if(isrc==31)SubTotalPt_unc = sum2_up;
if(isrc==32)SubTotalScale_unc = sum2_up;
if(isrc==33)SubTotalAbsolute_unc = sum2_up;
if(isrc==34)SubTotalMC_unc = sum2_up;
if(isrc==35)Total_unc = sum2_up;
if(isrc==36)TotalNoFlavor_unc = sum2_up;
if(isrc==37)TotalNoTime_unc = sum2_up;
if(isrc==38)TotalNoFlavorNoTime_unc = sum2_up;
if(isrc==39)FlavorZJet_unc = sum2_up;
if(isrc==40)FlavorPhotonJet_unc = sum2_up;
if(isrc==41)FlavorPureGluon_unc = sum2_up;
if(isrc==42)FlavorPureQuark_unc = sum2_up;
if(isrc==43)FlavorPureCharm_unc = sum2_up;
if(isrc==44)FlavorPureBottom_unc = sum2_up;
if(isrc==45)TimeRunBCD_unc = sum2_up;
if(isrc==46)TimeRunEF_unc = sum2_up;
if(isrc==47)TimeRunG_unc = sum2_up;
if(isrc==48)TimeRunH_unc = sum2_up;
if(isrc==49)CorrelationGroupMPFInSitu_unc = sum2_up;
if(isrc==50)CorrelationGroupIntercalibration_unc = sum2_up;
...
// jes source
 ...
 AbsoluteMPFBias_unc =0.0;
 Fragmentation_unc =0.0;
 SinglePionECAL_unc =0.0;
 SinglePionHCAL_unc =0.0;
 FlavorQCD_unc =0.0;
 TimePtEta_unc =0.0;
 RelativeJEREC1_unc =0.0;
 RelativeJEREC2_unc =0.0;
 RelativeJERHF_unc =0.0;
 RelativePtBB_unc =0.0;
 RelativePtEC1_unc =0.0;
 RelativePtEC2_unc =0.0;
 RelativePtHF_unc =0.0;
 RelativeBal_unc =0.0;
 RelativeFSR_unc =0.0;
 RelativeStatFSR_unc =0.0;
 RelativeStatEC_unc =0.0;
 RelativeStatHF_unc =0.0;
 PileUpDataMC_unc =0.0;
 PileUpPtRef_unc =0.0;
 PileUpPtBB_unc =0.0;
 PileUpPtEC1_unc =0.0;
 PileUpPtEC2_unc =0.0;
 PileUpPtHF_unc =0.0;
 PileUpMuZero_unc =0.0;
 PileUpEnvelope_unc =0.0;
 SubTotalPileUp_unc =0.0;
 SubTotalRelative_unc =0.0;
 SubTotalPt_unc =0.0;
 SubTotalScale_unc =0.0;
 SubTotalAbsolute_unc =0.0;
 SubTotalMC_unc =0.0;
 Total_unc =0.0;
 TotalNoFlavor_unc =0.0;
 TotalNoTime_unc =0.0;
 TotalNoFlavorNoTime_unc =0.0;
 FlavorZJet_unc =0.0;
 FlavorPhotonJet_unc =0.0;
 FlavorPureGluon_unc =0.0;
 FlavorPureQuark_unc =0.0;
 FlavorPureCharm_unc =0.0;
 FlavorPureBottom_unc =0.0;
 TimeRunBCD_unc =0.0;
 TimeRunEF_unc =0.0;
 TimeRunG_unc =0.0;
 TimeRunH_unc =0.0;
 CorrelationGroupMPFInSitu_unc =0.0;
 CorrelationGroupIntercalibration_unc =0.0;
 CorrelationGroupbJES_unc =0.0;
