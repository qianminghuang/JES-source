...
config.General.requestName   = 'WWQQ-3'
...
config.Data.inputDataset = '/WWToLNuQQ_13TeV-powheg/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6_ext2-v2/MINIAODSIM'
...
config.Data.outputDatasetTag = 'WWQQ-3'
